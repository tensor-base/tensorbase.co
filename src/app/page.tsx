    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-black text-white px-4">
      <div className="max-w-2xl w-full text-center">
        <div className="flex items-center justify-center gap-2 mb-6">
          <span className="font-bold text-xl">Tensor Base</span>
        </div>
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
          The future of <br />
          <span className="text-gray-400">frontend deployment</span>
        </h1>

        <p className="text-gray-400 mb-8 text-base md:text-lg">
          We&apos;re building the fastest, most reliable platform for deploying your frontend applications. Get ready to ship at the speed of thought.
        </p>
